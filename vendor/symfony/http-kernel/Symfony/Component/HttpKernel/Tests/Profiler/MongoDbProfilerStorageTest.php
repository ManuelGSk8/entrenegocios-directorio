...
class MongoDbProfilerStorageTest extends AbstractProfilerStorageTest
{
    ...
    public function getDsns()
    {
        return array(
            ...
            array('mongodb://user:password@localhost/admin_user/symfony_tests/profiler_data', array(
                'mongodb://user:password@localhost/admin_user',
                'symfony_tests',
                'profiler_data'
            )),
            array('mongodb://user:password@localhost:27009,localhost:27010/?replicaSet=rs-name&authSource=admin_user/symfony_tests/profiler_data', array(
                'mongodb://user:password@localhost:27009,localhost:27010/?replicaSet=rs-name&authSource=admin_user',
                'symfony_tests',
                'profiler_data'
            ))
        );
