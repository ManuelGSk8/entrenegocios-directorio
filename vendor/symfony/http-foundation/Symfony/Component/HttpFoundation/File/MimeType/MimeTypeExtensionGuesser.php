...
class MimeTypeExtensionGuesser implements ExtensionGuesserInterface
{
    ...
    protected $defaultExtensions = array(
        ...
        'application/x-fonts-bdf' => 'bdf',
        'application/x-fonts-ghostscript' => 'gsf',
        'application/x-fonts-linux-psf' => 'psf',
        'application/x-fonts-otf' => 'otf',
        'application/x-fonts-pcf' => 'pcf',
        'application/x-fonts-snf' => 'snf',
        'application/x-fonts-ttf' => 'ttf',
